...
const CareerAssessmentContentPage = () => {
  return (
    <div className="min-h-screen bg-background text-foreground overflow-hidden relative font-sans">
            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
              ...
              <div className="lg:col-span-6 space-y-6">
                ...
                <div className="pt-2 flex flex-wrap gap-4">
                  <CTAButton text="Get Career Clarity" variant="blue" />
                </div>
              </div>
      ...
      {/* 2. SO, WHAT EXACTLY IS A CAREER ASSESSMENT? (Light Theme) */}
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-8">
            ...
            <div className="w-full lg:w-[50%] flex flex-col items-center lg:items-start text-center lg:text-left z-20 space-y-6">
              ...
              <div className="bg-rose-500/10 border border-rose-500/20 rounded-2xl p-5 text-left w-full shadow-inner">
                ...
                <p className="text-[11px] text-slate-400 mt-3.5 italic">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 pt-2 w-full sm:w-auto self-start">
                <CTAButton text="Understand My Market Positioning" variant="blue" />
              </div>
            </div>

            {/* Right Column (Visual) */}
            <div className="w-full lg:w-[45%] z-10 flex justify-center">
                ...
                <div className="space-y-4 relative z-10">
                  ...
                  <div className="space-y-4 text-xs">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      <div className="bg-slate-900/60 border border-white/5 rounded-xl p-3.5 shadow-sm hover:border-violet-500/30 transition-all">
                      ...
                      <div className="bg-slate-900/60 border border-rose-500/15 rounded-xl p-3.5 shadow-sm hover:border-rose-500/30 transition-all">
                        <p className="text-[9px] text-rose-400 uppercase font-bold mb-1">
                          Recruiter Interpretation
                        </p>
                        <p className="text-xs font-extrabold text-rose-450">
                    ...
                    <div className="bg-slate-900/90 border border-green-500/20 rounded-xl p-4 shadow-sm hover:border-green-500/40 transition-all">
                      <p className="text-[9px] text-green-400 uppercase font-bold mb-1">
                        With Career Suitability Assessment
                      </p>
                      <div className="flex items-center gap-1.5 text-green-400 font-extrabold text-xs">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
            {[
              ...
              <div
                key={idx}
                className="bg-slate-900/50 backdrop-blur-md border border-white/5 rounded-2xl p-5 flex flex-col justify-between hover:-translate-y-1.5 transition-all duration-350 group relative overflow-hidden"
              >
                <div>
          ...
          <div className="flex justify-center mt-12">
            <CTAButton text="Build My Career Roadmap" variant="purple" />
          </div>
        </div>
      </section>

      {/* 5. WHAT YOU RECEIVE SECTION (Light Theme) */}
            ...
            {[
              ...
              >
                <div>
                  ...
                  <h3 className="text-xs md:text-sm font-extrabold mb-2 text-slate-800 dark:text-white">
                    {item.title}
                  </h3>
      ...
      <section className="py-24 bg-white dark:bg-background border-t border-slate-100 dark:border-slate-800">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="flex justify-center mt-12">
            <CTAButton text="Yes, Assess My Career Strategically" variant="blue" />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <p className="text-sm sm:text-base text-slate-655 dark:text-slate-300 leading-relaxed font-medium">
              ...
              <div className="pt-2">
                <CTAButton text="Improve My Career Direction" variant="blue" />
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10 text-center space-y-8">
          <div className="space-y-4 max-w-3xl mx-auto">
            <h2 className="text-3xl sm:text-4xl lg:text-[48px] font-black text-white tracking-tight leading-[1.1]">
              Your Career Decisions Shouldn't Be Left to Chance
            </h2>
            <p className="text-base sm:text-lg lg:text-xl text-slate-200 leading-relaxed font-bold">
              Understand your strengths. Build your roadmap. Achieve your goals.
            </p>
            <p className="text-sm sm:text-base text-slate-400 leading-relaxed max-w-2xl mx-auto text-center">
              With our career assessment and expert guidance, you'll make career choices with confidence and clarity.
            </p>
          </div>

          <div className="flex justify-center pt-2">
            <CTAButton
              text="Get Career Clarity"
              href="/contact-us"
              variant="blue"
            />
          </div>

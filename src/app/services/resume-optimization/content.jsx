            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              >
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-4">
                  Professional resume creation and optimization services that
                  help you stand out from the competition and land your dream
                  job.
                </p>

                <p className="text-lg leading-relaxed mb-8 font-medium">
                  This is not about generic templates. It is about creating a
                  tailored, ATS-optimized resume that speaks directly to
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground">
                A comprehensive approach to creating your perfect resume
              </p>
            </motion.div>

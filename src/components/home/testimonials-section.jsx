        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative bg-card border border-primary/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 hover:shadow-xl hover:shadow-primary/10 group"
            >
              ...
              <div className="relative">
                <svg
                  ...
                  className="absolute top-0 right-0 h-8 w-8 text-primary/10"
                >
                  <path

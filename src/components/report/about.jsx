...
const About = ({ data }) => {
  ...
  if (!aboutData) return <div>No about section data available</div>;
  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in">
      <div className="mb-6 md:mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1 md:mt-2 text-sm md:text-base">
            Evaluation of your LinkedIn about section
          </p>
        </div>
      ...
      <div className="mb-6 w-full">
        ...
        <p className="text-foreground leading-relaxed">{aboutData.summary}</p>
      </div>
      ...
      {aboutData.suggestions && aboutData.suggestions.length > 0 && (
        <Accordion
          type="single"

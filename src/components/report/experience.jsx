  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="mb-6 w-full">
        <p className="text-foreground">{experienceData.summary}</p>
      </div>
        ...
        >
          ...
          <AccordionContent className="pb-4">
            <ul className="space-y-3">
              {experienceData.strengths.map((strength, index) => (
      ...
      <Accordion type="single" collapsible className="mb-6 w-full">
        ...
        >
          ...
          <AccordionContent className="pb-4">
            <ul className="space-y-3">
              {experienceData.weaknesses.map((weakness, index) => (
                <li key={index} className="flex items-start">
      ...
      {experienceData.suggestions && experienceData.suggestions.length > 0 && (
        <Accordion type="single" collapsible className="w-full">
          ...
          >
            ...
            <AccordionContent className="pb-4">
              <ul className="space-y-3">
                {experienceData.suggestions.map((suggestion, index) => (
                  <li key={index} className="flex items-start">

...
const Testimonial03 = () => (
  <div className="min-h-screen flex justify-center items-center py-12 px-6">
    <div>
      <h2 className="mb-16 text-5xl font-semibold text-center tracking-[-0.03em] text-foreground">
        What Our Users Say
      </h2>
      <div className="max-w-(--breakpoint-xl) mx-auto columns-1 md:columns-2 lg:columns-3 gap-8">
        {testimonials.map((testimonial) => (
          <div
            key={testimonial.id}
            className="relative mb-8 bg-card border rounded-xl p-6 break-inside-avoid"
          >
            ...
            <p className="mt-5 text-[17px] text-foreground">

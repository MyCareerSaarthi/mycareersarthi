...
import { ModernDashboardAPI } from "@/components/api/modern-dashboard";

/**
 * Modern dashboard hook with advanced features and better state management
 */
export const useModernDashboard = () => {
  ...
  const fetchDashboardData = useCallback(
    async (isRefresh = false) => {
      ...
      try {
        ...
        const response = await ModernDashboardAPI.getDashboardAnalytics(token);
  ...
  const fetchMetrics = useCallback(async () => {
    ...
    try {
      ...
      const response = await ModernDashboardAPI.getPerformanceMetrics(token);
      if (response.success) {
  ...
  const fetchRecommendations = useCallback(async () => {
    ...
    try {
      ...
      const response = await ModernDashboardAPI.getSmartRecommendations(token);
      if (response.success) {
        setRecommendations(response.data.recommendations || []);
      }
    } catch (err) {
  ...
  const fetchProgress = useCallback(async () => {
    ...
    try {
      ...
      const response = await ModernDashboardAPI.getProgressTracking(token);
      if (response.success) {
  ...
  const fetchAchievements = useCallback(async () => {
    ...
    try {
      ...
      const response = await ModernDashboardAPI.getAchievementBadges(token);
      if (response.success) {
  ...
  const fetchActivity = useCallback(
    async (options = {}) => {
      ...
      try {
        ...
        const response = await ModernDashboardAPI.getRecentActivity(
          token,
          options
        );
        if (response.success) {
  ...
  const fetchInsights = useCallback(async () => {
    ...
    try {
      ...
      const response = await ModernDashboardAPI.getAIInsights(token);
      if (response.success) {
...
export default useModernDashboard;
